function parseTCPresponse(msg) {
    ...
    if (recv_json.b.eva[0] == "0")
        recv_json.b.eva[0] = 0;
    if (recv_json.b.eva[0] == "1")
        recv_json.b.eva[0] = 100;
    if (recv_json.b.eva[1] == "0")
        recv_json.b.eva[1] = 0;
    if (recv_json.b.eva[1] == "1")
        recv_json.b.eva[1] = 100;
    if (recv_json.b.eva[2] == "0")
        recv_json.b.eva[2] = 0;
    if (recv_json.b.eva[2] == "1")
        recv_json.b.eva[2] = 100;
    if (recv_json.b.eva[3] == "0")
        recv_json.b.eva[3] = 0;
    if (recv_json.b.eva[3] == "1")
        recv_json.b.eva[3] = 100;
...
//# sourceMappingURL=sistra-hidrobus.js.map